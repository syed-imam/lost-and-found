...
var {isOpen, image, name, price, desc, location, owner_name, owner_phone}= this.props.attributes;        
      
        return(
  <div>
       <Modal bsSize="large" aria-labelledby="contained-modal-title-lg" show={this.props.show} onHide={this.props.close}>
